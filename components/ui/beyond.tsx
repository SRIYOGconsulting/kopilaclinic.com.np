  ...
  return (
    <section className="bg-green-50 w-full mx-auto max-w-7xl min-w-screen">
      <div className="mt-10 mb-10 w-full">
        <div className="flex flex-col md:flex-row gap-2 md:gap-2  w-full max-w-7xl mx-auto px-4">

          {/* Static Text */}
          <p className="text-primary font-bold text-xl lg:text-2xl py-8 md:py-20 px-4 md:px-2 text-left lg:text-left w-full md:w-auto">
